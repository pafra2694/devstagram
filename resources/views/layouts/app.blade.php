            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    <nav class="flex gap-5 items-center">
                        <a href="#" class="flex items-center gap-1 bg-white border-2 border-gray-500 p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer shadow-md transition duration-300 hover:scale-105 hover:shadow-lg">
                        ...
                        <a class="font-bold text-gray-600 text-sm transition duration-300 hover:scale-110" href="#">{{$messageHi}}<span class="font-normal"> {{Auth::user()->name}}</span></a>
                ...
                @guest
                    <nav class="flex gap-5 items-center">
                        <a class="font-bold uppercase text-gray-600 text-sm transition duration-300 hover:scale-110" href="{{route('login')}}">Login</a>
